...
import com.powerlogic.jcompany.commons.PlcConstants.GUI.NAVEGADOR;
...
@PlcConfigAggregation(
		entity = br.particular.loteria.entity.MegaSena.class
...
public class GerarMegaSenaMB extends AppMB  {
	...
	*/
	@Produces  @Named("gerarmegasenaLista")
